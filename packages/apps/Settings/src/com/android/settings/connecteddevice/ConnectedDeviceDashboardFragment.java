...
public class ConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        final M2SsdPreferenceController m2SsdController = new M2SsdPreferenceController(context);
        if (lifecycle != null) {
            lifecycle.addObserver(m2SsdController);
        }
        controllers.add(m2SsdController);
