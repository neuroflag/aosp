...
include device/rockchip/rk356x/rk3568_firefly_iboard_3568z/BoardConfig.mk
...
PRODUCT_NAME := rk3568_firefly_iboard_3568z
PRODUCT_DEVICE := rk3568_firefly_iboard_3568z
PRODUCT_BRAND := Firefly
PRODUCT_MODEL := IBOARD-3568Z
...
PRODUCT_PROPERTY_OVERRIDES += ro.net.eth_primary=eth0
PRODUCT_PROPERTY_OVERRIDES += ro.net.eth_aux=eth1
...
PRODUCT_COPY_FILES += \
	device/rockchip/rk356x/rk3568_firefly_iboard_3568z/init.rk3568_firefly_iboard_3568z.rc:vendor/etc/init/init.rk3568_firefly_iboard_3568z.rc \
	device/rockchip/rk356x/rk3568_firefly_iboard_3568z/gps/u-blox.conf:system/etc/u-blox.conf
