...
include device/rockchip/rk356x/rk3568_firefly_aioj_ipc/BoardConfig.mk
...
PRODUCT_NAME := rk3568_firefly_aioj_ipc
PRODUCT_DEVICE := rk3568_firefly_aioj_ipc
PRODUCT_BRAND := Firefly
PRODUCT_MODEL := IPC-M10R800-A3568J
...
PRODUCT_COPY_FILES += \
	device/rockchip/rk356x/rk3568_firefly_aioj_ipc/init.rk3568_firefly_aioj_ipc.rc:vendor/etc/init/init.rk3568_firefly_aioj_ipc.rc \
	device/rockchip/rk356x/rk3568_firefly_aioj_ipc/gps/u-blox.conf:system/etc/u-blox.conf
