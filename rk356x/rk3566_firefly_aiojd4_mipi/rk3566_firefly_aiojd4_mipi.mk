...
include device/rockchip/rk356x/rk3566_firefly_aiojd4_mipi/BoardConfig.mk
...
PRODUCT_NAME := rk3566_firefly_aiojd4_mipi
PRODUCT_DEVICE := rk3566_firefly_aiojd4_mipi
...
#
PRODUCT_PROPERTY_OVERRIDES += vendor.hwc.device.primary=DSI-1
PRODUCT_PROPERTY_OVERRIDES += vendor.hwc.device.extend=DSI-2
...
PRODUCT_COPY_FILES += \
   device/rockchip/rk356x/rk3566_firefly_aiojd4_mipi/init.rk3566_firefly_aiojd4_mipi.rc:vendor/etc/init/init.rk3566_firefly_aiojd4_mipi.rc\
   device/rockchip/rk356x/rk3566_firefly_aiojd4_mipi/gps/u-blox.conf:system/etc/u-blox.conf
