...
include device/rockchip/rk356x/rk3568_firefly_aioj_mipi/BoardConfig.mk
...
PRODUCT_NAME := rk3568_firefly_aioj_mipi
PRODUCT_DEVICE := rk3568_firefly_aioj_mipi
PRODUCT_BRAND := Firefly
PRODUCT_MODEL := AIO-3568J
...
PRODUCT_COPY_FILES += \
	device/rockchip/rk356x/rk3568_firefly_aioj_mipi/init.rk3568_firefly_aioj_mipi.rc:vendor/etc/init/init.rk3568_firefly_aioj_mipi.rc \
	device/rockchip/rk356x/rk3568_firefly_aioj_mipi/gps/u-blox.conf:system/etc/u-blox.conf
