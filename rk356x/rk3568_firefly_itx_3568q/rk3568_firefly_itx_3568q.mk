...
include device/rockchip/rk356x/rk3568_firefly_itx_3568q/BoardConfig.mk
...
PRODUCT_NAME := rk3568_firefly_itx_3568q
PRODUCT_DEVICE := rk3568_firefly_itx_3568q
PRODUCT_BRAND := Firefly
PRODUCT_MODEL := ITX-3568Q
...
PRODUCT_PROPERTY_OVERRIDES += vendor.hwc.device.extend=eDP,DPI
...
PRODUCT_COPY_FILES += \
	device/rockchip/rk356x/rk3568_firefly_itx_3568q/init.rk3568_firefly_itx_3568q.rc:vendor/etc/init/init.rk3568_firefly_itx_3568q.rc \
	device/rockchip/rk356x/rk3568_firefly_itx_3568q/gps/u-blox.conf:system/etc/u-blox.conf \
	device/rockchip/rk356x/rk3568_firefly_itx_3568q/idc/ILITEK_ILITEK-TP.idc:system/usr/idc/ILITEK_ILITEK-TP.idc
