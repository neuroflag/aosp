...
PRODUCT_NAME := rk3566_roc_pc_mipi
PRODUCT_DEVICE := rk3566_roc_pc_mipi
PRODUCT_BRAND := Firefly
PRODUCT_MODEL := ROC-RK3566-PC
...
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.dto.configs=pcie


PRODUCT_COPY_FILES += \
	device/rockchip/rk356x/rk3566_roc_pc_mipi/gps/u-blox.conf:system/etc/u-blox.conf \
	$(LOCAL_PATH)/init.dto.rc:vendor/etc/init/init.dto.rc \
