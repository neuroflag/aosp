...
include device/rockchip/rk356x_box/rk3568_box_firefly_roc_pc/BoardConfig.mk
...
DEVICE_MANIFEST_FILE := device/rockchip/rk356x_box/rk3568_box_firefly_roc_pc/manifest.xml

PRODUCT_FSTAB_TEMPLATE := device/rockchip/rk356x_box/fstab_box.in

PRODUCT_CHARACTERISTICS := tv

PRODUCT_NAME := rk3568_box_firefly_roc_pc
PRODUCT_DEVICE := rk3568_box_firefly_roc_pc
PRODUCT_BRAND := Firefly
PRODUCT_MODEL := ROC-RK3568-PC
PRODUCT_MANUFACTURER := T-CHIP
PRODUCT_FIREFLY_NAME := BOX_HDMI
...
PRODUCT_PACKAGE_OVERLAYS += device/rockchip/rk356x_box/rk3568_box_firefly_roc_pc/overlay
...
PRODUCT_COPY_FILES += \
    device/rockchip/rk356x_box/rk3568_box_firefly_roc_pc/init.rk3568_box_firefly_roc_pc.rc:vendor/etc/init/init.rk3568_box_firefly_roc_pc.rc \
    device/rockchip/rk356x_box/rk3568_box_firefly_roc_pc/gps/u-blox.conf:system/etc/u-blox.conf
